    ...
    try {
      ...
      if (tribunal) {
        ...
        if (tribunalSite) {
          ...
          // ✅ FIX: Adicionar termos de decisão para evitar notícias/páginas genéricas
          searchQuery = `(ementa OR acórdão OR decisão) ${query} site:${tribunalSite} -noticia -taxa -edital`;
          ...
          if (results.length === 0) {
            ...
            searchQuery = `(ementa OR acórdão OR decisão) ${query} site:jus.br ${tribunalUpper} -noticia -taxa -edital`;
