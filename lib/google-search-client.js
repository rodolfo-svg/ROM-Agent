...
export class GoogleSearchClient {
  constructor(options = {}) {
    ...
    // Sites oficiais de tribunais + agregadores jurídicos para busca focada
    this.tribunalSites = [
      ...
      'tjpr.jus.br',
      'tjsc.jus.br',
      // Agregadores jurídicos (triple-check via Google)
      'jusbrasil.com.br'  // ✅ JusBrasil indexado via Google (evita bloqueio anti-bot)
    ];
  }
    ...
    try {
      ...
      if (tribunal) {
        ...
        if (tribunalSite) {
          ...
          searchQuery = `jurisprudencia ${query} site:${tribunalSite}`;
