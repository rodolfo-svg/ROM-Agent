    ...
    try {
      ...
      if (tribunal) {
        ...
        if (tribunalSite) {
          ...
          // ✅ TESTE: Query SIMPLES sem filtros (diagnóstico)
          searchQuery = `${query} site:${tribunalSite}`;
          ...
          if (results.length === 0) {
            ...
            usedFallback = true;
            // ✅ TESTE: Query SIMPLES sem filtros (diagnóstico)
            searchQuery = `${query} site:jus.br ${tribunalUpper}`;
