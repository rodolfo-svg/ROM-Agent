    ...
    try {
      ...
      if (tribunal) {
        ...
        if (tribunalSite) {
          ...
          // ✅ Para TJGO: adicionar termos específicos de decisão para evitar editais/compilações
          if (tribunalUpper === 'TJGO') {
            searchQuery = `(ementa OR acórdão OR decisão) ${query} site:${tribunalSite}`;
          } else {
