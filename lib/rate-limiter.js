...
const GENERAL_MAX = parseInt(process.env.RATE_LIMIT_GENERAL_MAX || '10000', 10); // ✅ AUMENTADO: 2000 → 10000
const CHAT_MAX = parseInt(process.env.RATE_LIMIT_CHAT_MAX || '500', 10); // ✅ AUMENTADO: 120 → 500
