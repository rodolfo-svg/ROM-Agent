...
async function generateStructuredDocuments(extractedText, baseName, timestamp) {
  ...
  filesGenerated.push('ÍNDICE_CRONOLÓGICO');
  console.log(`      ✓ Índice cronológico`);
  ...
  filesGenerated.push('ÍNDICE_POR_TIPO');
  console.log(`      ✓ Índice por tipo`);
  ...
  filesGenerated.push('ANÁLISE_PEDIDOS');
  console.log(`      ✓ Análise de pedidos`);
  ...
  filesGenerated.push('LEGISLAÇÃO_CITADA');
  console.log(`      ✓ Legislação citada`);
...
export async function processFile(filePath, onProgress = null) {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // Etapa 2: Aplicar 91 ferramentas (30-55%)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  emitProgress('Aplicando 91 ferramentas de processamento...', 30);
  // (já aplicadas em extractDocument, apenas salvando)
  ...
  emitProgress('Processamento de texto concluído', 55);

  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // Etapa 3: Gerar chunks para RAG (55-70%)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  emitProgress('Gerando chunks para RAG...', 55);
  let chunkFiles = [];
  ...
  emitProgress('Chunks gerados com sucesso', 70);

  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // Etapa 4: Criar metadados (70-75%)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  emitProgress('Criando metadados...', 70);
  const metadata = {
  ...
  emitProgress('Metadados salvos', 75);
