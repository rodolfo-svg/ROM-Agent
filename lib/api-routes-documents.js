...
import * as documentExtractionService from '../src/services/document-extraction-service.js';
 ...
 */
router.get('/extraction/desktop-path', (req, res) => {
  try {
 ...
 */
router.get('/documents/desktop-path', (req, res) => {
  try {
    const desktopPath = documentExtractionService.getDesktopPath();
    const basePath = path.join(desktopPath, 'ROM-Extractions');
